...
passport.use(new GoogleStrategy({
        ...
        callbackURL: "http://immanoj.in:3000/auth/google/callback"
    },
...
passport.use(new TwitterStrategy({
        ...
        callbackURL: "http://immanoj.in:3000/auth/twitter/callback"
    },
    function(token, tokenSecret, profile, done) {
        process.nextTick(function() {
...
passport.use(new FacebookStrategy({
    ...
    callbackURL: 'http://immanoj.in:3000/auth/facebook/callback'
