...
passport.use(new GoogleStrategy({
        ...
        callbackURL: "http://immanoj.in:8081/auth/google/callback"
    },
...
passport.use(new TwitterStrategy({
        ...
        callbackURL: "http://immanoj.in:8081/auth/twitter/callback"
    },
    function(token, tokenSecret, profile, done) {
        process.nextTick(function() {
...
passport.use(new FacebookStrategy({
    ...
    callbackURL: 'http://immanoj.in:8081/auth/facebook/callback'
